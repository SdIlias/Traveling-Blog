        ...
        <div class="image__container{{ $highlighted_posts->isEmpty() ? '' : ' highlighted' }}">
            @if($highlighted_posts->isEmpty())
                <div class="text">
                    ...
                    We are excited to have you here, where we explore the latest trends, share inspiring stories, and offer tips to make your travel experiences unforgettable. Our blog is dedicated to bringing you insightful content to help you discover new places, cultures, and ways to enjoy life on the go. Stay tuned for more posts that will inspire your next adventure.
                </div>
