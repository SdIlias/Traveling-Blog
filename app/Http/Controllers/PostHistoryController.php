...
class PostHistoryController extends Controller
{
    ...
    public function revert(int $postid, int $historyid)
    {
        ...
        if (Auth::Id() !== $post->user_id) {
            $post->user->notify(new PostNotification('INFO', 'The post was edited by'.Auth::User()->firstname.' '. Auth::User()->lastname. '. The post has been restored from history.', "/dashboard/posts/$post->id/edit/history/current/show"));
        }
